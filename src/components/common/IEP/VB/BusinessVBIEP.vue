...
import { getIEP } from 'network/assessmentIEPData.js'
import { getVBAssessment, postIEP, getAssessmentChartDataDetail } from 'network/businessStudentData.js'
...
export default {
  ...
  created () {
    ...
    this.getAssessmentChartDataDetail(this.getInfoKey)
  },
  mounted: function () {
    // 获取VBdata
  ...
  methods: {
    getAssessmentChartDataDetail (values) {
      console.log(values)
      getAssessmentChartDataDetail(values).then(res => {
    ...
    getIEP (values) {
      getIEP(values).then(res => {
        ...
        // for (var ind in res.plan[0]) {
        //   this.plan.push({
        //     key: res.plan[0][ind]['key'],
        //     title: res.plan[0][ind]['title'],
        //     description: res.plan[0][ind]['description'],
        //     disabled: res.plan[0][ind]['disabled']
        //   })
        // }
      })
    },
