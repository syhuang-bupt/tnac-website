<template>
  <a-table :columns="columns" :data-source="planDetail" bordered :pagination="pagination">
    <span slot="field" class="title-style">任务类型</span>
    ...
    <span slot="duration" class="title-style">截止日期</span>
