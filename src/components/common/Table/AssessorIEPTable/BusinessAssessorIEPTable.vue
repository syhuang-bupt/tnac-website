...
import { getAssessorAllBusinessStudentIEP } from 'network/businessStudentData.js'
const columns = [
  {
...
export default {
  ...
  created () {
    ...
    this.getAssessorAllBusinessStudentIEP(this.getInfoKey)
  },
  methods: {
    getAssessorAllBusinessStudentIEP (values) {
      getAssessorAllBusinessStudentIEP(values).then(res => {
        console.log(res)
