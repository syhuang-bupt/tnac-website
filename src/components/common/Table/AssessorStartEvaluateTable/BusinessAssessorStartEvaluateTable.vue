...
import { getAssessorAllBusinessStudentAssessment } from 'network/businessStudentData.js'
const columns = [
  {
...
export default {
  ...
  created () {
    ...
    this.getAssessorAllBusinessStudentAssessment(this.getInfoKey)
  },
  methods: {
    getAssessorAllBusinessStudentAssessment (values) {
      console.log(values)
      getAssessorAllBusinessStudentAssessment(values).then(res => {
        console.log(res)
