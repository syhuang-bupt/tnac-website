...
<script>
import YyDailyPlan from './YyDailyPlan.vue'
import YyMonthlyPlan from './YyMonthlyPlan.vue'
import { editCourseDetail } from 'network/editData.js'
import { getYyContentData } from 'network/getCourseContentData.js'
...
// import { YyDailyPlanData, YyMonthlyPlanData } from 'someData/index.js'
  ...
  methods: {
    ...
    isCourseHaveToday (values) {
      isCourseHaveToday(values).then(res => {
        ...
        this.YyDailyPlanData = res.content
        this.daysCourseSchedule = res.time
      })
    },
    getYyContentData () {
      getYyContentData().then(res => {
        this.yyCourseDetail = res
        console.log(res)
      })
    },
