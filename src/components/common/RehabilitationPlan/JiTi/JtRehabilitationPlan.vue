...
<script>
import JtDailyPlan from './JtDailyPlan.vue'
import JtMonthlyPlan from './JtMonthlyPlan.vue'
import { editCourseDetail } from 'network/editData.js'
import { getJtContentData } from 'network/getCourseContentData.js'
...
// import { JtDailyPlanData, JtMonthlyPlanData } from 'someData/index.js'
  ...
  methods: {
    ...
    isCourseHaveToday (values) {
      isCourseHaveToday(values).then(res => {
        ...
        this.JtDailyPlanData = res.content
        this.daysCourseSchedule = res.time
      })
    },
    getJtContentData () {
      getJtContentData().then(res => {
        this.jtCourseDetail = res
        console.log(res)
      })
    },
