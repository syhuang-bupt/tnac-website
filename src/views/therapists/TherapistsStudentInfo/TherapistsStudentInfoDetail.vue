    ...
    <div class="content-main" ref="maincontentheight">
      ...
      <div class="right-content">
        <a-card
          ...
          <!-- <view-score v-else-if="noTitleKey === 'ViewScore'" style="min-height:408px"/> -->
...
import ViewScore from './page/ViewScore'
import FeedbackComment from './page/FeedbackComment'
import { getTherapistStudentDetail } from 'network/getStudentDetail.js'
...
export default {
  ...
  created () {
    ...
    this.getTherapistStudentDetail(this.nameid)
  },
  methods: {
    getTherapistStudentDetail (values) {
      getTherapistStudentDetail(values).then(res => {
