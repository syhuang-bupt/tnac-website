    ...
    <div class="content-main" ref="maincontentheight">
      ...
      <div class="right-content">
        ...
        >
          ...
          <student-timetable v-else-if="noTitleKey === 'StudentTimetable'" :nameid="this.nameid" style="min-height:408px"/>
          <assessment-report v-else-if="noTitleKey === 'AssessmentReport'" style="min-height:408px"/>
          <feedback-comment v-else-if="noTitleKey === 'FeedbackComment'" style="min-height:408px"/>
...
import FeedbackComment from './page/FeedbackComment'
import IEPPlan from './page/IEPPlan'
import { getSupervisionStudentDetail } from 'network/getStudentDetail.js'
...
export default {
  ...
  created () {
    ...
    this.getSupervisionStudentDetail(this.nameid)
  },
  methods: {
    getSupervisionStudentDetail (values) {
      getSupervisionStudentDetail(values).then(res => {
