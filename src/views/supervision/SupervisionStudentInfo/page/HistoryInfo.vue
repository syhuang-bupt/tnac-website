...
import { getSupervisionStudentDetailHistoryInfo } from 'network/getStudentDetail.js'
...
export default {
  ...
  created () {
    this.getInfoKey.role = 1
    this.getInfoKey.name = this.nameid
    this.getSupervisionStudentDetailHistoryInfo(this.getInfoKey)
  },
  methods: {
    getSupervisionStudentDetailHistoryInfo (values) {
      console.log(values)
      getSupervisionStudentDetailHistoryInfo(values).then(res => {
        console.log(res)
