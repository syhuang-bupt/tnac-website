<template>
  <page-header-wrapper :title="false" >
    <div class="container">
      ...
      <div class="content">
        <avatar-without-dot :avatars="showAvatars" :routerInfo="'/director/freshmenmanage/business/detail/'"/>
      </div>
    </div>
  </page-header-wrapper>
</template>
...
<script>
import { getDirectorBusinessEvaluationStudentData } from 'network/businessStudentData.js'
...
export default {
  ...
  created () {
    this.getDirectorBusinessEvaluationStudentData()
    this.showAvatarsTmp = this.showAvatars
  },
  methods: {
    getDirectorBusinessEvaluationStudentData () {
      getDirectorBusinessEvaluationStudentData().then(res => {
