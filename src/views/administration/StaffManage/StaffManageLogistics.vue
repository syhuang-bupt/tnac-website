<template>
  <page-header-wrapper :title="false" >
    <div class="main-content">
      ...
      <a-table :data-source="otherDepartmentManageData" :columns="columns" class="stu-table" bordered>
...
<script>
import { getLogisticsDailyManage } from 'network/getStaffOrStudentData.js'
import AttendanceStateModel from '@/components/common/Model/AttendanceStateModel'
// import { otherDepartmentManageData } from 'someData/index.js'
export default {
  name: 'StaffManageLogistics',
  components: {
  ...
  methods: {
    getStaffDailyManage () {
      getLogisticsDailyManage().then(res => {
        console.log(res)
        this.otherDepartmentManageData = res
      })
    },
    ...
    attendanceStateChange (key) {
      this.otherDepartmentManageData[key].attendanceState = !this.otherDepartmentManageData[key].attendanceState
    }
  }
}
</script>
