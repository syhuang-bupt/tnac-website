<template>
  <page-header-wrapper :title="false" >
    <div class="main-content">
      ...
      <a-table :data-source="therapistsManageData" :columns="columns" class="stu-table" bordered>
...
<script>
import { getTherapistsDailyManage } from 'network/getStaffOrStudentData.js'
import AttendanceStateModel from '@/components/common/Model/AttendanceStateModel'
// import { therapistsManageData } from 'someData/index.js'
export default {
  name: 'StaffManageTherapists',
  components: {
  ...
  methods: {
    getStaffDailyManage () {
      getTherapistsDailyManage().then(res => {
        console.log(res)
        this.therapistsManageData = res
      })
    },
    ...
    attendanceStateChange (key) {
      this.therapistsManageData[key].attendanceState = !this.therapistsManageData[key].attendanceState
    }
  }
}
</script>
