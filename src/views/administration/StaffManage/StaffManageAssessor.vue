<template>
  <page-header-wrapper :title="false" >
    <div class="main-content">
      ...
      <a-table :data-source="assessorManageData" :columns="columns" class="stu-table" bordered>
...
<script>
import { getAssessorDailyManage } from 'network/getStaffOrStudentData.js'
import AttendanceStateModel from '@/components/common/Model/AttendanceStateModel'
// import { assessorManageData } from 'someData/index.js'
export default {
  name: 'StaffManageAssessor',
  components: {
  ...
  methods: {
    getStaffDailyManage () {
      getAssessorDailyManage().then(res => {
        console.log(res)
        this.assessorManageData = res
      })
    },
    ...
    attendanceStateChange (key) {
      this.assessorManageData[key].attendanceState = !this.assessorManageData[key].attendanceState
    }
  }
}
</script>
