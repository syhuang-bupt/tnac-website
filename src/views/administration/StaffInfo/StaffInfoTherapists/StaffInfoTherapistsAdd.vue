    ...
    <div class="main-content">
      ...
      <a-form
        ...
        <a-form-item label="擅长领域">
          <a-select
            v-decorator="['goodDomain',{rules: [{ required: true, message: '请选择康复师的擅长领域!', type: 'array' },],},]"
            mode="multiple"
...
<script>
import { addTherapists } from 'network/addNewStudentOrStaff.js'
...
export default {
  data () {
    return {
      ...
      goodDomainData: ['个训', '精细', '感统', '语言', '社交', '集体']
    }
  },
  beforeCreate () {
  ...
  methods: {
    addTherapists (values) {
      addTherapists(values).then(res => {
          console.log(res)
      })
    },
    normFile (e) {
