    ...
    <div class="content-main" ref="maincontentheight">
      ...
      <div class="right-content">
        <a-card
          ...
          <student-timetable bordered :courseDataSource="courseData"/>
        </a-card>
      </div>
    </div>
  </page-header-wrapper>
...
// import ChildTimetable from './page/ChildTimetable'
// import { studentdetail } from 'someData/index.js'
import { getParentStudentDetail, getParentStudentDetailStudentSchedule } from 'network/getStudentDetail.js'
export default {
  ...
  created () {
    ...
    this.getParentStudentDetail(this.nameid)
    this.getParentStudentDetailStudentSchedule(this.nameid)
  },
  methods: {
    getParentStudentDetail (values) {
      getParentStudentDetail(values).then(res => {
        this.studentdetail = res
        console.log(res)
      })
    },
    getParentStudentDetailStudentSchedule (values) {
      getParentStudentDetailStudentSchedule(values).then(res => {
        this.courseData = res
      })
    },
